...
# Adobe — Bewerbung Manager Solutions Consulting
...
- [Job Posting](https://careers.adobe.com/us/en/job/ADOBUSR167792EXTERNALENUS/Manager-Solutions-Consulting-Creative-Innovation-AI)
- Vault: `Privat/Karriere/Bewerbungen/adobe/`
- Cover Letter PDF: `_render/Nikolai-Bockholt_CoverLetter_Adobe.pdf`
- CV PDF: `_render/Nikolai-Bockholt_CV_Adobe.pdf`

## Context / Notes

- **Rolle:** Manager Solutions Consulting – Creative Innovation & AI · DACH
- **Job-ID:** R167792 · Posted 2026-04-24 · Munich + 3 weitere Standorte
- **Pitch:** 10 Jahre Google EMEA Creative Works (Solutions Consulting, 40+ C-Suite Workshops, 20+ Launches) + aktuell CDIO in Healthcare AI. Player-Coach-Rolle mit Fokus Firefly Foundry, GenStudio, Express for Enterprise.
- Cover Letter auf Englisch, CV auf Englisch. Beide als HTML + PDF vorhanden.
- Parallel läuft Serviceplan Group (Alexander Schill) — Timing-Entscheidung offen.
