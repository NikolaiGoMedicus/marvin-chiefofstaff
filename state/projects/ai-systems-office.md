...
# AI & Systems Office (ehem. CDIO Rolle)
...
Platform Entity (extern, eigener CEO) | Corporate Office | Platform Ops | Care Operations | People Office (Flo) | Marketing | Growth | **AI Tech & Systems Office (Nikolai)**

### Org-Struktur Entwürfe & Klärung
...
## Notion-Restrukturierung (16.04.)

✅ Org-Struktur in Notion umgesetzt. Bereiche-DB Office-Property + 2 Views ("Nach Office", "Alle Bereiche"), Offices-Übersicht auf Company HQ, Praxisintegration Test-Space mit Callout, Org Structure unter Company HQ. 1-Woche-Test in "Praxisintegration" mit 4er-Gruppe (Nikolai, Jens, Tim-Ole, Flo). Datenbank-Pflicht für alle.

## Franzi Löle

Doctolib-Hintergrund, PVS-Projektleitung bei Dr. Lipp (2 Jahre). Start 1.8. oder 1.9. Bestätigt: Lambda = bester Vendor. Sie + Antonia fragen bei Dr. Lipp nach wechselwilligen IT-Kandidaten.
